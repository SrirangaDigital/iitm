                    ...
                    <li class="widget-container widget_recent_news"><!-- widgets list -->
                        ...
                        <ul class="list-unstyled">
                            <li class="recent-news-wrap">
                                <h1 class="title-median">Forthcoming: Theme issue on "Higgs"</h1>
                                ...
                                <div class="recent-news-content clearfix">
                                    <div class="recent-news-text clear-margins">
                                        <p>
                                            Guest Editor: Debajyoti Choudhury <!-- <a href="#" class="moretag" title="read more">MORE</a> -->
                                        </p>
                                    </div>
                                </div>
                            </li>
                            <li class="recent-news-wrap">
                                <h1 class="title-median">Proceedings of the International Workshop/Conference on Computational Condensed Matter Physics and Materials Science<br /> (IWCCMP-2015)</h1>
                                <div class="recent-news-meta">
                                    <div class="recent-news-date">Posted on November 27, 2015</div>
                                </div>
                                <div class="recent-news-content clearfix">
                                    <div class="recent-news-text clear-margins">
                                        <p>
                                            Guest Editors: Anurag Srivastava, C. S. Praveen,<br /> H. S. Tewari <!-- <a href="#" class="moretag" title="read more">MORE</a> -->
                                        </p>
                                    </div>
                                </div>
                            </li>
